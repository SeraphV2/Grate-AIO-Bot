...
class Info(commands.Cog):
    ...
    async def help(self, ctx: commands.Context):
        ...
        logger.info(f"Fun Help command used by {ctx.author} in {ctx.guild.name if ctx.guild else 'DM'}")
        embed = discord.Embed(
            title="🎮 Fun Commands",
...
class FunHelpView(discord.ui.View):
    ...
    async def general_fun(self, interaction: discord.Interaction, button: discord.ui.Button):
        embed = discord.Embed(title="🎲 General Fun Commands", colour=discord.Colour.green())
    ...
    async def games(self, interaction: discord.Interaction, button: discord.ui.Button):
        embed = discord.Embed(title="🎮 Game Commands", colour=discord.Colour.purple())
    ...
    async def animals(self, interaction: discord.Interaction, button: discord.ui.Button):
        embed = discord.Embed(title="🐾 Animal Commands", colour=discord.Colour.teal())
    ...
    async def misc(self, interaction: discord.Interaction, button: discord.ui.Button):
        embed = discord.Embed(title="✨ Misc Fun Commands", colour=discord.Colour.orange())
